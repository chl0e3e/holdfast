...
//! authority: a committed dump of glibc 2.41's `wcwidth(3)` under
//! C.UTF-8 (ADR 0026). Both clients' `server-width.ts` are generated from
...
static BMP_ZERO: &[(u32, u32)] = &[
    ...
    (0xFE20, 0xFE2F), (0xFEFF, 0xFEFF), (0xFFA0, 0xFFA0),
];

static BMP_WIDE: &[(u32, u32)] = &[
    ...
    (0x3131, 0x3163), (0x3165, 0x318E), (0x3190, 0x31E5),
...
static HIGH_ZERO: &[(u32, u32)] = &[
    ...
    (0x1E4EC, 0x1E4EF), (0x1E5EE, 0x1E5EF), (0x1E8D0, 0x1E8D6),
    (0x1E944, 0x1E94A), (0xE0001, 0xE0001), (0xE0020, 0xE007F),
    (0xE0100, 0xE01EF),
];

static HIGH_WIDE: &[(u32, u32)] = &[
