 ...
 * (v0.1.14, pinned in Cargo.lock) — the same table the server-side
...
const BMP_ZERO: [number, number][] = [
  [0x00AD, 0x00AD], [0x0300, 0x036F], [0x0483, 0x0489],
  [0x0591, 0x05BD], [0x05BF, 0x05BF], [0x05C1, 0x05C2],
  [0x05C4, 0x05C5], [0x05C7, 0x05C7], [0x0605, 0x0605],
  ...
  [0x0859, 0x085B], [0x0890, 0x0891], [0x0898, 0x089F],
  ...
  [0x0B01, 0x0B01], [0x0B3C, 0x0B3C], [0x0B3E, 0x0B3F],
  [0x0B41, 0x0B44], [0x0B4D, 0x0B4D], [0x0B55, 0x0B57],
  [0x0B62, 0x0B63], [0x0B82, 0x0B82], [0x0BBE, 0x0BBE],
  [0x0BC0, 0x0BC0], [0x0BCD, 0x0BCD], [0x0BD7, 0x0BD7],
  ...
  [0x0CBC, 0x0CBC], [0x0CBF, 0x0CC0], [0x0CC2, 0x0CC2],
  [0x0CC6, 0x0CC8], [0x0CCA, 0x0CCD], [0x0CD5, 0x0CD6],
  [0x0CE2, 0x0CE3], [0x0D00, 0x0D01], [0x0D3B, 0x0D3C],
  [0x0D3E, 0x0D3E], [0x0D41, 0x0D44], [0x0D4D, 0x0D4E],
  [0x0D57, 0x0D57], [0x0D62, 0x0D63], [0x0D81, 0x0D81],
  [0x0DCA, 0x0DCA], [0x0DCF, 0x0DCF], [0x0DD2, 0x0DD4],
  [0x0DD6, 0x0DD6], [0x0DDF, 0x0DDF], [0x0E31, 0x0E31],
  ...
  [0x1B00, 0x1B03], [0x1B34, 0x1B3D], [0x1B42, 0x1B43],
  ...
  [0x302A, 0x302F], [0x3099, 0x309A], [0x3164, 0x3164],
  ...
  [0xA8C4, 0xA8C5], [0xA8E0, 0xA8F1], [0xA8FA, 0xA8FA],
  ...
  [0xFF9E, 0xFFA0], [0xFFF0, 0xFFF8],
];

const BMP_WIDE: [number, number][] = [
  [0x1100, 0x115F], [0x17A4, 0x17A4], [0x231A, 0x231B],
  [0x2329, 0x232A], [0x23E9, 0x23EC], [0x23F0, 0x23F0],
  ...
  [0x2FF0, 0x3029], [0x3030, 0x303E], [0x3041, 0x3096],
  [0x309B, 0x30FF], [0x3105, 0x312F], [0x3131, 0x3163],
  [0x3165, 0x318E], [0x3190, 0x31E3], [0x31EF, 0x321E],
...
const HIGH_ZERO: [number, number][] = [
  ...
  [0x111B6, 0x111BE], [0x111C2, 0x111C3], [0x111C9, 0x111CC],
  ...
  [0x1133B, 0x1133C], [0x1133E, 0x1133E], [0x11340, 0x11340],
  [0x11357, 0x11357], [0x11366, 0x1136C], [0x11370, 0x11374],
  [0x11438, 0x1143F], [0x11442, 0x11444], [0x11446, 0x11446],
  [0x1145E, 0x1145E], [0x114B0, 0x114B0], [0x114B3, 0x114B8],
  [0x114BA, 0x114BA], [0x114BD, 0x114BD], [0x114BF, 0x114C0],
  [0x114C2, 0x114C3], [0x115AF, 0x115AF], [0x115B2, 0x115B5],
  ...
  [0x11930, 0x11930], [0x1193B, 0x1193C], [0x1193E, 0x1193F],
  [0x11941, 0x11941], [0x11943, 0x11943], [0x119D4, 0x119D7],
  [0x119DA, 0x119DB], [0x119E0, 0x119E0], [0x11A01, 0x11A0A],
  [0x11A33, 0x11A38], [0x11A3A, 0x11A3E], [0x11A47, 0x11A47],
  [0x11A51, 0x11A56], [0x11A59, 0x11A5B], [0x11A84, 0x11A96],
  ...
  [0x11EF3, 0x11EF4], [0x11F00, 0x11F02], [0x11F36, 0x11F3A],
  [0x11F40, 0x11F40], [0x11F42, 0x11F42], [0x13440, 0x13440],
  ...
  [0x1D16E, 0x1D182], [0x1D185, 0x1D18B], [0x1D1AA, 0x1D1AD],
  ...
  [0x1E944, 0x1E94A], [0xE0000, 0xE0FFF],
];

const HIGH_WIDE: [number, number][] = [
